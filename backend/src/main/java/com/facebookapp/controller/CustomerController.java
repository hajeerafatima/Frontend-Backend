...
//	public CustomerLoginResponceDto loginEmployee(@RequestBody CustomerLoginDto customerLoginDto) {
//		
//		this.doAuthentication(customerLoginDto.getEmail(), customerLoginDto.getPassword());
//
//		UserDetails userDetails = this.customerService.loadUserByUsername(customerLoginDto.getEmail());
//
//		String token = this.jwtTokenUtil.generateToken(userDetails);
//		
//		CustomerLoginResponceDto response =   CustomerLoginResponceDto.builder()
//				.token(token)
//				.emial(userDetails.getUsername()).build();
//		
//		return response;
//	}
...
//		try {
//			authencationManager.authenticate(usernamePasswordAuthenticationToken);
//
