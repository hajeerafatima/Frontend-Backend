...
const Home = () => {
  ...
  // const employeeCount = () => {
  //   axios.get('http://localhost:8080/dashboard/employee_count')
  //     .then(response => {
  //       const data = response.data;
  //       if (!isNaN(data)) {
  //         setEmployeeTotal(data);
  ...
  const salaryCount = () => {
    ...
    // const salaryCount = () => {
  //   axios.get('http://localhost:8080/dashboard/salary_count')
  //     .then(response => {
  //       const data = response.data;
  //       if (!isNaN(data)) {
  //         setSalaryTotal(data);
  ...
  // const AdminRecords = () => {
  //   axios.get('http://localhost:8080/dashboard/admin_records')
  //     .then(response => {
  //       const adminData = response.data;
  //       setAdmins(adminData);
  //     })
